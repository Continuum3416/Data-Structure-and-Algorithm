...
class AbstractHashMap : public AbstractMap<Key,Value> {
  ...
  public:
    using typename Base::Entry, typename Base::const_iterator, typename Base::begin, typename Base::end;
...
class ChainHashMap : public AbstractHashMap<Key, Value, Hash> {
  ...
  protected:
    using typename Base::abstract_iter_rep, typename Base::get_rep, typename Base::table_sz, typename Base::sz;
...
public:
      // Function to get the size of a specific bucket
