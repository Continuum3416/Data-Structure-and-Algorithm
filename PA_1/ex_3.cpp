...
int main() {
    ...
    cout << "Progression with default increment: ";
    ...
    cout << "Prime progression with default start value: ";
    prog = new PrimeProgression();
    prog->print_progression(10);
    
    cout << "Prime progression with start value 97: ";
    prog = new PrimeProgression(97);
    prog->print_progression(10);
